...
Extractors are manually written Python modules. See `PATTERN_CREATION_GUIDE.md` for the complete workflow:

1. **Fetch sample HTML:**
   ```bash
   uv run scripts/fetch_sample.py <url>
   ```

2. **Analyze HTML structure** to identify extraction points

3. **Create extractor module:** `generated_extractors/<domain>.py`
...
See `PATTERN_CREATION_GUIDE.md` for detailed instructions and best practices.
